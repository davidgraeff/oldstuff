...
MACRO(ADD_DEBIAN_PACKAGE DEBNAME)
  ...
  IF ("${ARGV1}" STREQUAL "")
      ...
      ADD_CUSTOM_COMMAND(
        ...
        COMMAND   ${CMAKE_COMMAND} -E echo
        "Architecture: ${DEBIAN_ARCHITECTURE}" >> ${CONTROL_FILE}
      )   
      ...
      IF ( DEFINED PACKAGE_ICON )
        ADD_CUSTOM_COMMAND( OUTPUT ${CONTROL_FILE}
          COMMAND   ${CMAKE_COMMAND} -E echo
           "XB-Maemo-Icon-26: ${PACKAGE_ICON}" >> ${CONTROL_FILE}
          APPEND)   
      ENDIF ( DEFINED PACKAGE_ICON )
