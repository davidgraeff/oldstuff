...
import com.scenecontrol.ledcontrol.listadapter.SocketsListAdapter.ViewHolder;
...
public class ProfilesListAdapter extends BaseAdapter implements ModelAvailableInterface, ModelChangeListener, ListAdapter {
	...
	public ProfilesListAdapter(Context context) {
		...
		LedApplication.getServerconnection().addModelAvailableListener(this);
	}
	
	@Override
	public void finalize() {
		LedApplication.getServerconnection().removeModelAvailableListener(this);
	}
