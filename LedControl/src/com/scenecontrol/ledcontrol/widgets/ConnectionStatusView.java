...
public class ConnectionStatusView extends LinearLayout implements ConnectionObserverInterface, ExecutionServerMessageInterface, OnClickListener {
	...
	private void doAdditionalConstructorWork() {
		...
		if (LedApplication.getServerconnection().isConnected())
			executionServerConnected(LedApplication.getServerconnection().getConnection());
	}
