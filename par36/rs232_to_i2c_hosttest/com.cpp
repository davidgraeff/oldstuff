...
#define UART_BROADCAST_ADDRESS 0
...
// 			case 's':
// 			{
// 				printf("One device address\n");
// 				const unsigned char t[6] = {0xff, 0xff, UART_BROADCAST_ADDRESS, CMD_ACK, 0x00, 0x00};
// 				sp.writeData((char*)t,sizeof(t));
// 				usleep(1000*100); // 60 ms
// 				int r = sp.readData(input, sizeof(input));
// 				//if (t[1] != 0)
...
// 			}
			...
			{
				printf("Scan lights:");
				const unsigned char t[6] = {0xff, 0xff, 0, 0, 0, 0x00};
				sp.writeData((char*)t,sizeof(t));
